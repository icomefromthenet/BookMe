...
BEGIN
    ...
    DECLARE cronType VARCHAR(10) DEFAULT 'minute';
	...
	ELSE 
		...
		WHILE i <= rangeOccurances DO
			...
			CASE
				...
				WHEN splitValue REGEXP getRegexPatternA(cronType) THEN
				...
				WHEN splitValue REGEXP getRegexPatternB(cronType) THEN
				...
				WHEN splitValue REGEXP getRegexPatternC(cronType) > 0 THEN				
				...
				WHEN splitValue REGEXP getRegexPatternD(cronType) > 0 THEN				
				...
				WHEN splitValue REGEXP getRegexPatternE(cronType) > 0 THEN
