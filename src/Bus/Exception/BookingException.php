...
class BookingException extends BookMeException implements BusException
{
     ...
     * @return static
     */
    public static function hasFailedToReserveSlots(TakeBookingCommand $oCommand, DBALException $oDatabaseException)
    {
     ...
     * @return static
     */
    public static function hasFailedToTakeBooking(TakeBookingCommand $oCommand, DBALException $oDatabaseException)
    {
        $exception = new static(
     ...
     * @return static
     */
    public static function hasFailedToClearBooking(ClearBookingCommand $oCommand, DBALException $oDatabaseException)
    {
        $exception = new static(
